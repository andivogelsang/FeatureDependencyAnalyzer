...
public class FA {
  ...
  /**
   * adds component to LA and establishes a mapping from last added feature to component
   */
  ...
  /**
   * adds component to LA and establishes a mapping from specified feature to component
   */
  ...
  public void addDependency(Feature sourceFeature, Feature targetFeature, Component sourceComponent,
    ...
    FeatureDependency dep = new FirstOrderFeatureDependency(sourceFeature, targetFeature,
        sourceComponent, targetComponent, sharedChannels);
